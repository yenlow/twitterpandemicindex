...
excluded_places = ['',' ','none','\n', '\\n','europe','planet earth',
                   ...
                   'right here, right now', 'inside','outside','bed',
                   'climbing out of an oubliette','c-137','no','yes','maybe',
                   'gotham','gaia','i sây','mysoul','dm04',
                   'loading...','visit our dedicated website @',
                   'narnia','basement','neverland','reality','oz','whoville',
                   'closet','east coast!','in the 6','idk',
                   'in transit','in limbo','purgatory','word',
                   ...
                   'eu','latinoamérica','latam','latin america','south america',
                   '🇪🇺','🇫🇷 / 🇩🇪','europe','european union 🇪🇺','se asia','#AFRICA #MENA',
                   'usa | uk | asia | australia','far east',
                   'rome *** world *** 🇨🇦🏂⚡',
...
blacklist_regex = r'world|planet|universe|global|earth|somewhere|border|home|^[0-9.]+$|^ÜT:|🌎|🌍|🌏|☁️|🌙|🏡|✈|➡|🏳️|⭕|🌐|👽|\s|heaven|^www.|.com$|^http[s]*:/[/w]+|unknown|reality|¯\_(ツ)_/¯'
...
'socal': 'los angeles',
'so cal': 'los angeles',
'the bay': 'san francisco bay',
'norcal': 'san francisco bay',
'east bay, ca': 'san francisco bay',
...
'west midlands':'west midlands county, united kingdom',
'west midlands, england':'west midlands county, united kingdom',
